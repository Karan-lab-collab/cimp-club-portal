...
export default function ViewClubs() {
  ...
  const fetchClubs = async () => {
    try {
      const res = await axios.get("https://cimp-club-portal.onrender.com/api/clubs");
  ...
  const deleteClub = async (clubName) => {
    ...
    try {
      await axios.delete(`https://cimp-club-portal.onrender.com/api/clubs/${encodeURIComponent(clubName)}`);
      fetchClubs();
    } catch {
